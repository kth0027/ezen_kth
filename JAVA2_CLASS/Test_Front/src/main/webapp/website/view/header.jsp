...
<body>
	...
	<header class="container headerpage d-flex justify-content-center align-items-center py-3">
		...
		<ul class="nav nav-pills col-md-10 justify-content-end">
			<li class="nav-item"><a href="/Test_Front/website/view/main.jsp" class="nav-link active" aria-current="page">Home</a> <a href="/Test_Front/website/view/main.jsp" class="nav-link active" aria-current="page" style="display: none;">Home</a></li>
