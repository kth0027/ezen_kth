...
<body>
	...
	<div class="container boardwritepage border">
		<div class="row d-flex justify-content-center align-items-center">
			<form class="formbox" action="../../controller/boardwritecontroller.jsp" method="post" enctype="multipart/form-data">
				<div class="col-12">
					제목 :
				...
				<span>
					<button value="back" class="text-center btn btn-dark offset-4 col-4 mt-3">
