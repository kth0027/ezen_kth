...
<body>
	...
	<div class="container">
		...
		<a href="productwrite.jsp"><button>제품등록</button></a> <a href="productchart.jsp"><button>제품통계</button></a>
		<h3>제품 목록</h3>
		<table class="table">
			<tr>
				<th>이미지</th>
			...
			<tr>
				...
				<td><a href="#">
						...
						<button class="btn-outline-info" onclick="activeupdate(<%=product.getP_num()%>)">상태변경</button>
				</a></td>
			</tr>
			<%	} %>
		</table>
