...
<body>
	...
	<div class="container">
		...
		<div class="text-center totalbox">
			<p>
				총 상품 가격
				<span class="carttotal"><%= decimalFormat.format(totalprice) %></span>
				+ 총 배송비
				<span class="carttotal">3,000</span>
				= 총 주문금액 :
				<span class="carttotal"><%= decimalFormat.format( totalprice+3000 ) %></span>
			</p>
		</div>
		<div class="row">
