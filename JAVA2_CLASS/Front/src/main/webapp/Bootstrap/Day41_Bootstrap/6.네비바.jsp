...
<body>
	...
	<div class="container">
		<!--  박스권 -->
		<nav class="navbar navbar-expand-md navbar-light fixed-top" style="background-color: yellow;">
			<!-- navbar : 메뉴 박스권 -->
			<!-- navbar-expand-lg : 1200px 이상 일때 -->
			...
			<div class="collapse navbar-collapse" id="navbarcontents">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						<!--  드랍다운  --> <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
