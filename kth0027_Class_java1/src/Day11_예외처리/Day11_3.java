...
public class Day11_3 {
	...
	public static void main(String[] args) {
		...
		// System 클래스 [ 모든 멤버가 static이기 때문에 객체 필요없음 ]
			// 1. exit : 프로그램 종료
...
//			try {
//				System.exit(i); // i를 exit()넣기 [ i=5일때 예외가 없기때문에 exit 실행 ]
//			} catch (Exception e) {}
//			
//		} // for end
		...
		// 3. 시스템 정보 읽기 [ System.getProperty("호출기") ] 
		System.out.println("pc os : " + System.getProperty("os.name") );
		System.out.println("pc os 버전 : " + System.getProperty("os.version") );
		...
		System.out.println("자바 설치 경로 : " + System.getProperty("java.home") );
