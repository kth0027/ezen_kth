...
//			
//		// p.502
//			// 4. getBytes() : 문자열 바이트열로 변환
//			String str = "안녕하세요"; // 한글 1개당 2바이트 // 영문 1개당 1바이트
//			
//			byte [] bytes3 = str.getBytes(); // String을 바이트로 변환 후 배열에 대입
//			System.out.println( bytes3.length); // 한글 글자수
//			// 바이트 == > 문자열
...
//			
//		// P. 504
//			// 5. indexOf () : 문자열 찾기 [ 인수 : 찾을 문자열 반환 : 인덱스 ]
...
//			
//			// 9. spilt (분리기준) : 문자열 분리
//			String[] ssn3 = ssn2.split("-"); // "-" 기준으로 분해 => 2 문자열
//			
...
//			System.out.println( ssn3[1] );
		...
		// p. 510
			// 12. valueOf() : 기본타입을 문자열 변환
			String str5 = String.valueOf(10); // 정수형[int] => 문자열 "10"
			String str6 = String.valueOf(10.5); // 실수형[double] => 문자열 "10"
			String str7 = String.valueOf(true); // 논리 => 문자열 "10"
