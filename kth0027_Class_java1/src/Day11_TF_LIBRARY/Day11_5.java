...
//			1. 된다! 네이버 블로그&포스트
//			2. 스프링 부트 실전 활용 마스터
//			3. Tucker의 Go언어 프로그래밍
//			4. 혼자 공부하는 C언어
//			
//	2. scanner => System.in.read() 로 대체
//
...
//};
	...
	// 1. 메뉴 : while 무한루프
	// 2. 입력받기 : scanner / System.read 활용
	// 3. 세부메뉴 구현 

	public static void main(String[] args) throws IOException {
		
		// 0. 준비물
		String[] 도서목록 = {"된다! 네이버 블로그&포스트" , "스프링 부트 실전 활용 마스터", "Tucker의 Go언어 프로그래밍", "혼자 공부하는 C언어"}; 
