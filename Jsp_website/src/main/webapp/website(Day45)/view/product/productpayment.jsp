...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
				<h3>배송 정보</h3>
				<span class="pview"> 받는 사람 정보 </span>
				...
				<div class="row">
					...
					<div class="col-md-8">
						<input id="prequest" type="text" name="prequest" class="form-control" placeholder="배송시 요청사항을 입력해주세요">
					</div>
				</div>
				<br>
				<hr>
				<br> <span class="pview"> 받는 사람 주소 </span>
			...
			<div class="col-md-6 border p-3">
				...
				<div class="row">
					...
					<div class="col-md-9 text-right payment">
						<span id="totalprice" class="payment"><%=totalprice%></span> ( 총 주문상품수 :
						<%=carts.size()%>
						)
					</div>
					<div class="col-md-3">총 배송비</div>
					<div class="col-md-9 text-right">
						<span id="totaldeliverypay" class="payment">3000</span>
					</div>
					<div class="col-md-3">사용 포인트</div>
					<div class="col-md-9 text-right ">
						<span id="usepoint" class="payment">0</span>
					</div>
