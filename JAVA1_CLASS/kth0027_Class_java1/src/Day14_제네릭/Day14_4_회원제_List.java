	...
	public static void main(String[] args) {
		...
		try {
			FileInputStream fileInputStream = new FileInputStream(
					"C:/Users/505/git/back_develop/JAVA(김태호)/src/Day14/userlist.txt");
				...
				if (idcheck) {
					...
					try {
						FileOutputStream fileOutputStream = new FileOutputStream(
								"C:/Users/505/git/back_develop/JAVA(김태호)/src/Day14/userlist.txt", true);
							...
							if (ch2 == 1) {
								...
								try {
									...
									for (User temp2 : users) {
										// 회원 분류
										String outtemp = temp2.getId() + "," + temp2.getPassword() + ","
												+ temp2.getName() + "\n";
