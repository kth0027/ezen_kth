...
public class Day12_4_차량번호분배 {
	...
	/*
	 * 문제 : 차량번호 랜덤으로 0000 ~ 9999 사이의 난수 10개 // 1. 모든 차량을 배열에 저장 // 2. 차량 끝자리 홀수 배열
	 * 관리 // 3. 차량 끝자리 짝수 배열 관리
	 * 
	 * // 1. 모든차량 배열 // 2. 홀수차량 배열 // 3. 홀수차량 배열
	 */
...
//	
//	System.out.println("0~9999 중의 난수 : ");
