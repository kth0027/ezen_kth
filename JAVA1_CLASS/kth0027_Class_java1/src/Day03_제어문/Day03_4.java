...
//		}
		...
		// .p 122 예4) 1부터 100까지 누계 출력
		int 누적합계 = 0; // 공백 < > 0
		for ( int i = 1; i <= 100; i++) { 누적합계 += i;}
		System.out.println("1부터 100까지 누적합계 : " + 누적합계 );
		System.out.println("\n-------------------------------");
		
		// 예5-1) 1부터 100까지 7의 배수 누적합계 (i는 0부터 100까지 7씩 증가 누적합계)
		int 누적합계2 = 0;
		for ( int i = 0; i<=100; i+=7) {누적합계2 += i; }
		System.out.println( "1~100까지 7의 배수 누적합계 : " + 누적합계2 );
		System.out.println("\n-------------------------------");
		
		// 예5-2) 
		int 누적합계3 = 0;
		for ( int i = 0; i<=100; i++) {if (i%7==0) 누적합계3 += i;}
		System.out.println( "1~100까지 7의 배수 누적합계 : " + 누적합계3 );
		System.out.println("\n-------------------------------");
