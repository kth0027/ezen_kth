...
//		System.out.println("scres[0] : " + scores[0] );
//		System.out.println("scres[1] : " + scores[1] );
//		System.out.println("scres[2] : " + scores[2] );
//		
//		
//		// 3. 반복문 활용
//		int sum = 0;
...
//		System.out.println( " 배열내 평균 : " + (sum)/3 );
		...
		System.out.println( 정수배열1[1]); // 해당 인덱스의 값 출력
		System.out.println( 정수배열1[2]); // 해당 인덱스의 값 출력
