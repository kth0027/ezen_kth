...
public class Day02_3 {
	...
	/* p.64 연산자 [ 연산시 사용되는 특수문자 ]
		...
		비교연산자 : 결과 T/F
			>= 이상 [크거나 같다]		>초과 [크다]		== [같다]
			<= 이상 [작거나 같다]		<미만 [작다]		!= [같지않다]
		
		논리연산자 : 비교연산작 2개 이상일 때
	...
	public static void main(String[] args) {
		...
		System.out.println( " 더하기 : " + 정수1 + 정수2 ); 	// 문자 + 숫자 + 숫자 => 연결 연산자
		...
		// p.92 : 논리연산자 : and / or : 비교연산자가 2개이상일때
			// AND : 2개이상의 비교연산자가 모두 TRUE => 결과 TRUE // 하나라도 FALSE => 결과 FLASE 
		...
		// .p100 : 조건 연산자 [ 조건식 (비교연산자) ? 참(true) : 거짓(false) ]
		int 점수 = 85;
