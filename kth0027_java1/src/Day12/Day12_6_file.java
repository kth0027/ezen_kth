...
public class Day12_6_file {
	...
	public static void main(String[] args) throws Exception {
		...
		FileOutputStream fileOutputStream = 
				new FileOutputStream("C:\\Users\\505\\git\\back_develop\\JAVA(김태호)\\src\\Day12/test.txt");
		
			// 입출력 관련된 클래스 => 무조건 예외처리발생
		String 문자열 ="이클립스에서 작성된 문서입니다"; // 한글14 * 2 => 28 + 2(sp:공백) => 30
		...
		FileInputStream fileInputStream = 
				new FileInputStream("C:\\Users\\505\\git\\back_develop\\JAVA(김태호)\\src\\Day12/test.txt");
