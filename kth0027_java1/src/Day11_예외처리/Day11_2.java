...
public class Day11_2 {
	...
	public static void main(String[] args) { // m s
		...
		if (obj1.equals(obj2)) {
			System.out.println("1. 두객체는 동등합니다");
		} else {
			System.out.println("1. 두객체는 다릅니다.");
		}

		if (obj1.equals(obj3)) {
			System.out.println("2. 두객체는 동등합니다");
		} else {
			System.out.println("2. 두객체는 다릅니다.");
		}
		...
		cloned2.toString();
			...
			cloned2 = original2.getMember3(); // 메모리할당
