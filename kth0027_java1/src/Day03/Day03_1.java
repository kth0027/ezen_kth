...
public class Day03_1 { // c s
	...
	// 제어문 : if(논리제어), Switch(데이터제어)
		// 목적 : 경우의 수에 따른 코드 처리
			// 예) 학생에게 1000원주고 콜라 심부름
				// 1. 가장 가따운 편의점 => 콜라 x 	=>	false
				// 2. 다음 가따운 편의점 => 콜라 1200	=>	false
	...
	public static void main(String[] args) { // m s
			...
			int score = 93;
			// 정수가 90보다 크기 때문에 실행
			if ( score >= 90 )	{System.out.println("정수가 90보다 큽니다");		System.out.println("등급은 A입니다");}
			// 정수가 90보다 미만 아니기 때문에 실행x
			if ( score < 90 )	{System.out.println("정수가 90보다 작습니다");	System.out.println("등급은 B입니다");}
