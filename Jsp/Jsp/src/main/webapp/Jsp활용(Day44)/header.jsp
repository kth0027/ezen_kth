...
<body>
	...
	ArrayList<Board> boards = new ArrayList<>(); // 게시글 초기화
	fileInputStream = new FileInputStream("C:/Users/505/git/ezen_kth/Jsp/src/main/java/Test/boardlist.txt");
	bytes = new byte[1000];
	...
	<ul>
		<%
		if (loginid != null) {
			out.print("<li>" + loginid + "님 안녕하세요</li>");
		}
		%>
		<%
		if (loginid != null) {
