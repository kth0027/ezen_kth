...
<%
	...
	//String folderpath = "C:/Users/505-t/git/web_ezen_1/jsp/src/main/webapp/website/upload"; // 학원

	String folderpath = "C:/Users/pc/git/ezen_kth/Jsp/src/main/webapp/website/upload"; // 집
