			...
			<div class="col-md-6">
				<form id="signupform" action="../../controller/signupcontroller.jsp" method="post" onsubmit="return signupcheck()">
					<div class="row">
						...
						<div class="col-md-8">
							<input id="id" onchange="signupcheck();" type="text" name="id" class="form-control" maxlength="15">
						</div>
					</div>
					<div>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input id="password" onchange="signupcheck();" type="password" name="password" class="form-control" maxlength="15">
						</div>
					</div>
					<div class="row">
						<!-- 3:8 -->
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input id="name" onchange="signupcheck();" type="text" name="name" class="form-control" maxlength="15">
						</div>
					</div>
					<div>
					...
					<div class="row">
						...
						<div class="col-md-8 text-center">
							<input type="radio" name="sex" value="man" id="sex1" onchange="signupcheck();"> 남 <input type="radio" name="sex" value="woman" id="sex2" onchange="signupcheck();"> 여
						</div>
						<div>
